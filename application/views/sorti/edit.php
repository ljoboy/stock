    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Sorti > Modifier</h3>
            </div>
			<?php echo form_open('sorti/edit/'.$sorti['id_sorti']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_articles_site" class="form-control">
								...
								{
									$selected = ($articles_site['id_articles_site'] == $sorti['id_articles_site']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="qte" value="<?php echo ($this->input->post('qte') ? $this->input->post('qte') : $sorti['qte']); ?>" class="form-control" id="qte" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="date_sortie" value="<?php echo ($this->input->post('date_sortie') ? $this->input->post('date_sortie') : $sorti['date_sortie']); ?>" class="form-control" id="date_sortie" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nom_client" value="<?php echo ($this->input->post('nom_client') ? $this->input->post('nom_client') : $sorti['nom_client']); ?>" class="form-control" id="nom_client" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="ijd" value="<?php echo ($this->input->post('ijd') ? $this->input->post('ijd') : $sorti['ijd']); ?>" class="form-control" id="ijd" />

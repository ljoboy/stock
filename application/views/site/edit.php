    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Site > Modifier</h3>
            </div>
			<?php echo form_open('site/edit/'.$site['id_site']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="type" class="form-control">
								...
								{
									$selected = ($value == $site['type']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="superviseur" class="form-control">
								...
								{
									$selected = ($user['id_user'] == $site['superviseur']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nom_site" value="<?php echo ($this->input->post('nom_site') ? $this->input->post('nom_site') : $site['nom_site']); ?>" class="form-control" id="nom_site" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="details" value="<?php echo ($this->input->post('details') ? $this->input->post('details') : $site['details']); ?>" class="form-control" id="details" />

    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Articles Site > Modifier</h3>
            </div>
			<?php echo form_open('articles_site/edit/'.$articles_site['id_articles_site']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_article" class="form-control">
								...
								{
									$selected = ($article['id_article'] == $articles_site['id_article']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_site" class="form-control">
								...
								{
									$selected = ($site['id_site'] == $articles_site['id_site']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="qte_min" value="<?php echo ($this->input->post('qte_min') ? $this->input->post('qte_min') : $articles_site['qte_min']); ?>" class="form-control" id="qte_min" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="qte" value="<?php echo ($this->input->post('qte') ? $this->input->post('qte') : $articles_site['qte']); ?>" class="form-control" id="qte" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="date_update" value="<?php echo ($this->input->post('date_update') ? $this->input->post('date_update') : $articles_site['date_update']); ?>" class="form-control" id="date_update" />

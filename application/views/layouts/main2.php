...
<div class="container body">
	<div class="main_container">
		<div class="col-md-3 left_col">
			<div class="left_col scroll-view">
				<div class="navbar nav_title" style="border: 0;">
					<a href="<?php echo index_page() ?>" class="site_title"><i class="fa fa-paw"></i>
						<span><?php echo APP_NAME_FULL ?></span></a>
				</div>
				...
				<div class="profile clearfix">
					<div class="profile_pic">
						<img
							src="<?php echo base_url('assets/bower_components/gentelella/production/images/img.png') ?>"
							alt="user image" class="img-circle profile_img">
					</div>
					<div class="profile_info">
						<span>Bienvenue,</span>
						<h2><?php echo ucwords($this->session->nom_complet); ?></h2>
					</div>
				</div>
				<!-- /menu profile quick info -->
						...
						<li class="">
							<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
							   aria-expanded="false">
								<img
									src="<?php echo base_url('assets/bower_components/gentelella/production/images/img.png') ?>"
									alt="User image"><?php echo ucwords($this->session->nom_complet); ?>
								<span class=" fa fa-angle-down"></span>
							</a>
							<ul class="dropdown-menu dropdown-usermenu pull-right">
								<li><a href="<?php echo site_url('auth/profil') ?>"> Profil</a></li>
								<li>
									<a href="javascript:;">
			...
			<div class="">
				<div class="page-title">
					<div class="title_left">
						<h3><?php echo isset($title) ? $title : APP_NAME_FULL ?></h3>
					</div>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2><?php echo isset($title) ? $title : APP_NAME_FULL ?></h2>
		...
		<footer>
			...
			<strong>© <?php echo date('Y') . " " . COMPAGNY_NAME ?></strong>, Tous droits réservés | Designed by <a
				href="https://about.me/ljoboy">Lijerbul LJOBOY</a>
			<div class="clearfix"></div>
		</footer>
		<!-- /footer content -->
	</div>
...
<!-- Bootstrap -->
<script
	src="<?php echo base_url('assets/bower_components/gentelella/vendors/bootstrap/dist/js/bootstrap.min.js'); ?>"></script>
<!-- FastClick -->
...
<script src="<?php echo base_url('assets/bower_components/gentelella/build/js/custom.min.js'); ?>"></script>
</body>
</html>

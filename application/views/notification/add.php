    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Notification > Ajouter</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="body" value="<?php echo $this->input->post('body'); ?>" class="form-control" id="body" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="date_notif" value="<?php echo $this->input->post('date_notif'); ?>" class="form-control" id="date_notif" />
						</div>
					</div>
				</div>
			</div>
